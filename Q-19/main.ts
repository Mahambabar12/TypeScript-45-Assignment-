...
let _Lists: string[] = ["Maham" , "Maryam" , "Hani"];
...
_Lists.forEach(guest => {
    console.log(`${guest},you all are invited to dinner!`);
...
while (_Lists.length > 2) {
    let remove_Guest :string | undefined = _Lists.pop()
    if(remove_Guest !== undefined){
        console.log(`Sorry, ${remove_Guest}, you can't invite you`);
...
//Print updated list
console.log(`Updated List of guest: ${_Lists}`);